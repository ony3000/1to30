  ...
  return (
    <button
      ...
      className={classNames(
        ...
        before:rounded-[inherit] before:text-[inherit] before:opacity-10 before:transition-all
        before:duration-300 before:content-[""] hover:relative hover:before:bg-current focus:relative
        focus:before:bg-current active:before:bg-current active:before:opacity-20`,
        className,
      )}
      disabled={disabled}
